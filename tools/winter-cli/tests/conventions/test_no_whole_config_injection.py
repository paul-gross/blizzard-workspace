...
Convention: `winter-context:/architecture/dependency-injection.md`.
...
CONVENTION_DOC = "winter-context:/architecture/dependency-injection.md"
...
# `winter-context:/architecture/dependency-injection.md` — when adding a new
...
ALLOWED_FILES = frozenset(
    {
        ...
        "modules/workspace/extension_agentsmd_service.py",
        ...
        "modules/doctor/env_bands_probe_service.py",  # doctor probe service — warns on [env.<name>.vars] bands naming an env that does not exist (lifecycle carve-out: walks the registry and every env dir)
