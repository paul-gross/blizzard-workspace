...
Convention: `winter-context:/architecture/module-layout.md`,
`winter-context:/standards/protocol-conformance.md`.
...
CONVENTION_DOC = "winter-context:/architecture/module-layout.md"
