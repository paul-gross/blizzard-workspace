...
- `/ws-garden <axis>` — Run one gardening pass over a declared axis and draft the work its findings earn
...
| Garden, tend, sweep an axis, architectural review pass                                                | `/ws-garden <axis>` — resolves the axis from `blizzard-context:/garden/index.md`                                                                                                                                                                                   |
