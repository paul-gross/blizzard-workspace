...
[workspace:/context/winter-cli/usage/ws/pull.md](workspace:/context/winter-cli/usage/ws/pull.md) — plus
...
- repo-d: no upstream — skipped (run `winter ws connect` to track a feature branch)
```
